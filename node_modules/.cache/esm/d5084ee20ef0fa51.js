let multer,NewEmployee,fs,path,Joi;_0ef‍.x([["default",()=>_0ef‍.o]]);_0ef‍.w("multer",[["default",["multer"],function(v){multer=v}]]);_0ef‍.w("../../model/Forms/newEmployee",[["default",["NewEmployee"],function(v){NewEmployee=v}]]);_0ef‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_0ef‍.w("path",[["default",["path"],function(v){path=v}]]);_0ef‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
...
const newEmployeeController = {
  ...
  async allEmployee(req, res, next) {
    let allEmployee;
    try {
      allEmployee = await NewEmployee.find({ }).select('-__V -updatedAt');
